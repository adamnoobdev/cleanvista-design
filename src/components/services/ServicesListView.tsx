...
interface ServicesListViewProps {
  ...
  heroImageUrl?: string; // Add this property with optional type
}
      ...
      <section className="py-12 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-3xl font-bold mb-4">Utforska våra tjänster</h2>
          ...
          <div className="mt-12 bg-secondary p-6 rounded-sm animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div className="bg-white p-5 rounded-sm">
                <h4 className="text-lg font-semibold mb-3">Våra mest populära tjänster</h4>
